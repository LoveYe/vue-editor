...
export default {
    ...
    changeZToBottom({ commit, state }, { id }) {
        console.log(state.rects[id].zIndex)
    ...
    deteteLayer({ commit }, { id }) {
        commit(types.DELETE_LAYER, { id });
    },
    ...
    //改变字
    changewyText({ commit }, { id, text }) {
        console.log('改变的值为', id, text)
        commit(types.CHANGE_TEXT, { id, text })
    },
    //改变字体颜色
    changewyColor({ commit }, { id, text }) {
        console.log('改变的值为', id, text)
        commit(types.CHANGE_COLOR, { id, text })
    },
    //改变背景颜色
    changewyBgColor({ commit }, { id, text }) {
        console.log('改变的值为', id, text)
        commit(types.CHANGE_BG_TEXTCOLOR, { id, text })
    },
};
