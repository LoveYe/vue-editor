export default {
    computed: {
        ...
        useType() {
            return this.activeRect === null ? '' : this.$store.state.rect.rects[this.activeRect].type
        },
        useBackGroundColor() {
            return this.activeRect === null ? '' : this.$store.state.rect.rects[this.activeRect].backGroundColor
        },
        useText() {
            return this.activeRect === null ? '' : this.$store.state.rect.rects[this.activeRect].text
        },
        width() {
    ...
    methods: {
        ...
        toDelete() {
            this.$store.dispatch('rect/deteteLayer', { id: this.activeRect });
        },
        ...
        changeText(ev) {
            let text = parseInt(ev.target.value);
            console.log('改变的字体', text)
            this.$store.dispatch('rect/changewyText', { id: this.activeRect, text: text })
        },
        changeColor(e) {
            console.log('字体颜色', e)
            let text = e
            this.$store.dispatch('rect/changewyColor', { id: this.activeRect, text: text })
        },
        changebackGroundColor(e) {
            console.log('字体背景色', e)

            let text = e
            this.$store.dispatch('rect/changewyBgColor', { id: this.activeRect, text: text })
        }
    }
}